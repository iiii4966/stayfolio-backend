...
from .models       import PickImage, Pick
from .views        import PickListView, PickView
from test_fixtures import _gen_fixture_data


class PickListTest(TestCase):
    data = _gen_fixture_data()

    def setUp(self):
        tags          = self.data['place_tag']
    ...
    def test_get_pick(self):
        ...
        response = c.get('/pick/1', content_type='application/json')
        ...
        self.assertEqual(response.json(),
            ...
            'images'        : [
                "https://www.stayfolio.com/system/pictures/images/000/037/809/large/e057b2c932688b16dae7849024afeb3b757954fe.jpg?1567645869",
